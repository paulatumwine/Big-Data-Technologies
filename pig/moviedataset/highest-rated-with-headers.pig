...
withHeaders = foreach top20 generate $0 as MovieId, $1 as Genre, ratings::rating as Rating, adventure::title as Title;
store withHeaders INTO 'highest-rated-with-headers-output' using org.apache.pig.piggybank.storage.CSVExcelStorage('\t', 'NO_MULTILINE', 'UNIX', 'WRITE_OUTPUT_HEADER');;
